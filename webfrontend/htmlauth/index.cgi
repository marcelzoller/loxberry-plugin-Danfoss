...
LoxBerry::Web::lbheader("Danfoss Plugin V$version", "http://www.loxwiki.eu/Danfoss/Zoller", "help.html");
...
$template->param( LOGDATEI => "/admin/system/tools/logfile.cgi?logfile=plugins/$lbpplugindir/danfoss.log&header=html&format=template");
